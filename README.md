...
> **NOTE**: This branch contains instructions for setting up the non-"Temporalized" version of the temporal-documentation-helper, switch to the `temporal` branch for the original version.
